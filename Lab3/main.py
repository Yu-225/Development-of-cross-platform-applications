...
class ModelApp:
    def __init__(self):
        self.style = {"text": "Код писався вночі, тому виглядає дивно... довно що він взагалі запускається..."}
...
class ViewApp(tk.Frame):
    def __init__(self, master, callback):
        ...
        for p, t in options:
            tk.Button(frames[p], text=t, cursor="hand2", command=lambda s={p: t}: callback(s)).pack(side="left")
